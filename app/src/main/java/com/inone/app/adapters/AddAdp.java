...
import com.inone.app.activities.AddAdress;
 ...
 * with image loading
 * */
public class AddAdp extends RecyclerView.Adapter<AddAdp.MyViewHolder> {
     ...
     * */
    public AddAdp(Activity activity, JSONArray l1) {
        this.l1 = l1;
        this.activity = activity;
    }

    public AddAdp(Activity activity, Fragment fragment, JSONArray l1) {
        this.l1 = l1;
        this.activity = activity;
        ...
        try {
            ...
            holder.rl1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(activity.getApplicationContext(), AddAdress.class);
                    intent.putExtra(Const.data,  "");
