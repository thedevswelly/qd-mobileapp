 ...
 * with image loading
 * */
public class TranAdp extends RecyclerView.Adapter<TranAdp.MyViewHolder> {
     ...
     * */
    public TranAdp(Activity activity, JSONArray l1) {
        this.l1 = l1;
    ...
    public TranAdp(Activity activity, Fragment fragment, JSONArray l1) {
        this.l1 = l1;
        this.activity = activity;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.tran_item, parent, false);
