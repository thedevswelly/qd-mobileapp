 ...
 * with image loading
 * */
public class SetAdp1 extends RecyclerView.Adapter<SetAdp1.MyViewHolder> {
     ...
     * */
    public SetAdp1(Activity activity, List<SetDto> l1) {
        this.l1 = l1;
        this.activity = activity;
        listner = (ItemClickListner) activity;
    }

    public SetAdp1(Activity activity, Fragment fragment, List<SetDto> l1) {
        this.l1 = l1;
        this.activity = activity;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.set_item1, parent, false);
...
//            holder.imv.setImageResource(menuData.getIcon());
            if(menuData.getTitle().equals(activity.getString(R.string.title))) {
                holder.txt1.setText(menuData.getDesc());
