 ...
 * with image loading
 * */
public class FavAdp extends RecyclerView.Adapter<FavAdp.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView location_icon,cross_icon;
     ...
     * */
    public FavAdp(Activity activity, JSONArray l1) {
        this.l1 = l1;
        this.activity = activity;
        listner = (ItemClickListner) activity;
    }

    public FavAdp(Activity activity, Fragment fragment, JSONArray l1) {
        this.l1 = l1;
        this.activity = activity;
