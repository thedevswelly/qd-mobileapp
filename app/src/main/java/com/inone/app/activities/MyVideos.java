...
public class MyVideos extends AppCompatActivity implements ItemClickListner {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        loader = Const.getLoader(MyVideos.this,getString(R.string.loading));
    ...
    private void addAdp() {
        try {
            ...
            MainAdp catAdp = new MainAdp(MyVideos.this,l1);

            LinearLayoutManager layoutManager
                    = new LinearLayoutManager(MyVideos.this, LinearLayoutManager.VERTICAL, false);
