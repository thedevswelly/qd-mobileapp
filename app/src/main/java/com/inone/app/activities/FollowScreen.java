...
public class FollowScreen extends AppCompatActivity implements ItemClickListner {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.follow_screen);
        loader = Const.getLoader(FollowScreen.this,getString(R.string.loading));
    ...
    private void addAdp() {
        try {
            ...
            UserAdp catAdp = new UserAdp(FollowScreen.this,l1);

            LinearLayoutManager layoutManager
                    = new LinearLayoutManager(FollowScreen.this, LinearLayoutManager.VERTICAL, false);
