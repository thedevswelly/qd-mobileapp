...
import com.inone.app.adapters.TranAdp;
...
public class Trans extends AppCompatActivity implements ItemClickListner {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        loader = Const.getLoader(Trans.this,getString(R.string.loading));
    ...
    private void addAdp() {
        try {
            ...
            TranAdp catAdp = new TranAdp(Trans.this,l1);

            LinearLayoutManager layoutManager
                    = new LinearLayoutManager(Trans.this, LinearLayoutManager.VERTICAL, false);
