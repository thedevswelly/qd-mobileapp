...
public class VendorDash extends AppCompatActivity implements ItemClickListner {
    ...
    private void requestReadPhoneStatePermission() {
        ActivityCompat.requestPermissions(VendorDash.this, str,
                1);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dash_ven1);
    ...
    private void setMenu() {
        try {
            ...
            MenuAdp catAdp = new MenuAdp(VendorDash.this, menus);

            LinearLayoutManager layoutManager
                    = new LinearLayoutManager(VendorDash.this, LinearLayoutManager.VERTICAL, false);
